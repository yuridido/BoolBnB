...
<div class="sponsor">
  <div class="container-center">
      <div class="card">
        ...
        <div class="features">
          <ul>
            <li><span> Prezzo: </span>{{$sponsors[0]->sponsor_price}} €</li>
            <li><span>Tempo: </span>{{$sponsors[0]->sponsor_time}} ore</li>
          </ul>
        </div>

      <a href="{{route('logged.pay',['id'=>$apartment->id,'id_sponsor'=>$sponsors[0]->id,'price'=>$sponsors[0]->sponsor_price])}}"" class="btn">Procedi per il pagamento</a>
      </div>
...
<div class="card">
  ...
  <div class="features">
    <ul>
      <li><span>Prezzo: </span> {{$sponsors[1]->sponsor_price}} €</li>
      <li><span>Tempo: </span>{{$sponsors[1]->sponsor_time}} ore</li>
    </ul>
  </div>

   <a href="{{route('logged.pay',['id'=>$apartment->id,'id_sponsor'=>$sponsors[1]->id,'price'=>$sponsors[1]->sponsor_price])}}"" class="btn">Procedi per il pagamento</a>
</div>
...
<div class="card">
  ...
  <div class="features">
    <ul>
      <li><span>Prezzo: </span>{{$sponsors[2]->sponsor_price}} €</li>
      <li><span>Tempo: </span>{{$sponsors[2]->sponsor_time}} ore</li>
    </ul>
  </div>
  <a href="{{route('logged.pay',['id'=>$apartment->id,'id_sponsor'=>$sponsors[2]->id,'price'=>$sponsors[2]->sponsor_price])}}" class="btn">Procedi per il pagamento</a>
